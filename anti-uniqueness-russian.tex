...
The data presented above will be analyzed in more depth in section \ref{sec:existence-and-uniqueness}. But a pattern of limited but systematic counterexamples should be dealt with first. As noted previously, not all Russian speakers evince anti-uniqueness in (\ref{anna3}). That is to say, the combination in (\ref{no-anti-unique}) is grammatical for these speakers, and similarly for the sentences in (\ref{maria3}), (\ref{boris3}), (\ref{lena3}) and (\ref{olga3}).
