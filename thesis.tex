...
Anti-uniqueness effects occur when DP-internal \textit{only} is in the scope of negation. Both predicative and argumental anti-uniqueness effects are possible, as (\ref{scott}) and (\ref{only-goal}) respectively demonstrate.
...
In summary, anti-uniqueness effects are evident with definite descriptions containing DP-internal \textit{only} in the scope of negation, both in the predicate and argument positions.
